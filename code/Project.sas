...
DATE: Monday, June 30, 2025     TIME: 4:49:28 PM
PROJECT: Project
PROJECT PATH: C:\Users\seford\git\serv_diag\eg\Project.egp
---------------------------------------- */
...
%LET _CLIENTPROJECTPATH='C:\Users\seford\git\serv_diag\eg\Project.egp';
...
/* -------------------------------------------------------------------
   ...
   Generated on: Monday, June 30, 2025 at 4:48:42 PM
...
%LET SYSLAST=WORK.ONEWAYFREQOFENGINESIZEINCARS;
%LET _CLIENTTASKLABEL='get_contents';
%LET _CLIENTPROCESSFLOWNAME='Process Flow';
%LET _CLIENTPROJECTPATH='C:\Users\seford\git\serv_diag\eg\Project.egp';
%LET _CLIENTPROJECTPATHHOST='l10k712';
%LET _CLIENTPROJECTNAME='Project.egp';
...
proc contents data=work.onewayfreqofenginesizeincars;run;
